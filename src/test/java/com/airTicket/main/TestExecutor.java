...
import com.airTicket.test.TestBoundary;
import com.airTicket.test.TestException;
import com.airTicket.test.TestFunction;
...
public class TestExecutor {
		...
		public void test() {
			...
			Result result = junit.run(TestFunction.class);
			try {
